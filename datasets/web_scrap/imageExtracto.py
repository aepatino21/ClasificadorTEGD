...
driver.get('https://www.istockphoto.com/es/search/2/image?phrase=Indigena%20amazonia')
...
for i in range(1, int(limite)): 
    driver.get(f'https://www.istockphoto.com/es/search/2/image?phrase=Indigena%20amazonia&page={i}')
    ...
    for foto in fotos: 
        ...
        if childs[1].tag_name == 'picture':
            ...
            if not any(not_keyword in alt_text for not_keyword in not_keywords) :
...
df_fotos.to_csv('FotosIndigenasIStock.csv')